...
%  first so that it will be easier for debug. Later, in part 4, we
...
%  Once our cost function implementation is correct, you should now
...
%  the labels. We will now uset the "predict" function to use the
